        ...
        Box(
            ...
            Column(
                ...
                Row(
                    ...
                    AppText(text = "${state.chicken.thirst.roundToInt()}/${state.chicken.maxThirst}")
                }
                Row(
                    horizontalArrangement = Arrangement.spacedBy(5.dp),
                    verticalAlignment = Alignment.CenterVertically
                    ...
                    AppText(text = state.chicken.thirstSecondsLeft.secondsToTimeStr())
                }
                AppButton(
                    enabled = state.canRefillThirst,
                    onClick = { onEvent(GameEvent.RefillThirst) }
                ) {
                    Row(
                        horizontalArrangement = Arrangement.spacedBy(5.dp),
                        verticalAlignment = Alignment.CenterVertically
                        ...
                        AppText(text = state.chicken.thirstRefillPrice.toString(), fontSize = 25.sp)
                    }
                }
                AppButton(
                    enabled = state.canUpgradeThirst,
                    onClick = { onEvent(GameEvent.UpgradeThirst) }
                ) {
                    Row(
                        horizontalArrangement = Arrangement.spacedBy(5.dp),
                        verticalAlignment = Alignment.CenterVertically
                        ...
                        AppText(
                            text = state.chicken.thirstUpgradePrice.toString(),
                            fontSize = 25.sp
                        )
                    }
                }
